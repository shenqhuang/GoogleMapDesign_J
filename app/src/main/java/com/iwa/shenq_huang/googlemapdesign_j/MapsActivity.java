package com.iwa.shenq_huang.googlemapdesign_j;
...
*/
        ...
        */
        ...
        /*
        // 增加第一點
        LatLng MyPoint = new LatLng(25.0564734,121.4704767);
        mMap.addMarker(new MarkerOptions().position(MyPoint)
            .title("群光大樓 Julia 沒來上班")
                .snippet("還在家裡睡覺")
        );


        // 增加第二點
        LatLng MyPoint2 = new LatLng(25.0525468,121.4728371);
        mMap.addMarker(new MarkerOptions().position(MyPoint2)
                .title("22222")
                .snippet("22222")
        );
        ...
        // 點擊後 跳出的內容
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(MyPoint2,14));
*/
